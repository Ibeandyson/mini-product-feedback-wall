...
export function FeedbackForm({ onAuthRequired }: FeedbackFormProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-[#1a1a2e] to-[#16162a] border border-[#3d3d5c]/50 rounded-2xl p-6 shadow-xl">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h2 className="text-xl font-bold text-white tracking-tight">Submit Feedback</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 bg-[#0f0f1a] border border-[#3d3d5c] rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#6366f1] focus:border-transparent transition-all resize-none"
            maxLength={1000}
            disabled={!isConfigured}
          />
        </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] text-white font-semibold rounded-xl hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-[#6366f1]/25"
        >
          {isSubmitting ? (
